  ...
  <div class="flex h-screen">
    ...
    <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
      <div class="max-w-md w-full p-6">
        ...
        <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Join our community with full access</h1>
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div>
            ...
            <textarea 
              ...
              rows="2"
              required
              class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"></textarea>
          </div>
          ...
          <div>
            ...
            <div class="mt-1 flex items-center">
              <span v-if="!imagePreview" class="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                <svg class="h-full w-full text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 20.993V24H0v-2.996A14.96 14.96 0 0112 15c3.183 0 6.235 1.264 8.485 3.515A14.952 14.952 0 0124 20.993zM16 9a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              </span>
              <img v-else :src="imagePreview" class="h-12 w-12 rounded-full object-cover">
              
              <label for="image" class="ml-5 cursor-pointer">
                <span class="py-2 px-3 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                  Change
                </span>
                <input 
                  id="image"
        ...
        <div class="mt-4 text-sm text-gray-600 text-center">
          <p>Already have an account? <router-link to="/login" class="text-black hover:underline">Login here</router-link></p>
        </div>
      </div>
    </div>
  </div>
